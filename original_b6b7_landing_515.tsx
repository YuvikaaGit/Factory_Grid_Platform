  ...
  return (
    <div style={{ minHeight: '100vh', background: '#07111D', color: '#fff', overflowX: 'hidden', position: 'relative' }}>
      ...
      <div className="fg-ambient">
        <div className="fg-ambient-grid" />
        <div className="fg-ambient-orb-1" />
        <div className="fg-ambient-orb-2" />
      </div>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          <button className="fg-btn-ghost" style={{ padding: '10px 20px', fontSize: 14 }} onClick={() => onNavigate('login')}>Sign In</button>
          <button className="fg-btn-primary" style={{ padding: '10px 22px', fontSize: 14 }} onClick={() => onNavigate('login')}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                <button className="fg-btn-primary" onClick={() => onNavigate('login')}>
                  Start Sourcing <ArrowRight size={16} />
                </button>
                <button className="fg-btn-ghost" onClick={() => onNavigate('login')}>
                  Book Demo
                </button>
              </div>
              {/* Trust signals */}
      ...
      <section style={{ padding: '120px 0', position: 'relative', zIndex: 1, borderTop: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' }}>
        ...
        <div className="fg-container" style={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <button className="fg-btn-ghost" onClick={() => onNavigate('login')} style={{ padding: '16px 36px', fontSize: 16 }}>
              Schedule Demo
            </button>
          </div>
        </div>
